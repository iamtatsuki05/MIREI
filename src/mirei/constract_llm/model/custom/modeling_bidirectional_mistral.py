...
class MistralBiModel(MistralModel, SentenceEncoderMixin):
    ...
    # transformers 4.56.1 no longer calls this hook from MistralModel.forward, so the forward() override
    ...
    # Copied verbatim from transformers 4.56.1 MistralModel.forward, except for the marked block that
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        # The upstream code below built causal masks (sliding-window ones when config.sliding_window
        # is set); the bidirectional mask is built instead.
...
class MistralBiForSequenceClassification(MistralPreTrainedModel):
    def __init__(
        self,
        config: MistralConfig,
        pooling_mode: str = 'mean',
