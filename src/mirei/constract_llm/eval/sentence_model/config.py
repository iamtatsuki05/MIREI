...
class CLIConfig(BaseModel):
    ...
    batch_size: int = Field(32, gt=0, description='Batch size used to encode sentences')
    ...
    miracl_split: str = Field('dev', description='Dataset split for MIRACL positive pairs')
    ...
    positive_pair_dataset_split: str = Field('dev', description='HF dataset split for positive pairs')
