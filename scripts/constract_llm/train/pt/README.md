...
- `Llama-JP-1B/stage1-bs8192.json` / `Llama-JP-1B/stage2-bs1024.json` - Configuration for intermediate-scale Japanese pre-training of Llama-1B
- `Llama-EN-1B/stage1-bs8192.json` / `Llama-EN-1B/stage2-bs1024.json` - Configuration for intermediate-scale English pre-training of Llama-1B
- `Llama-JP-3B/stage1-bs16384.json` / `Llama-JP-3B/stage2-bs2048.json` - Configuration for scaled Japanese pre-training of Llama-3B
- `Llama-EN-3B/stage1-bs16384.json` / `Llama-EN-3B/stage2-bs2048.json` - Configuration for scaled English pre-training of Llama-3B
...
- `ModernBERT-JP-1B/stage1-bs8192.json` / `ModernBERT-JP-1B/stage2-bs1024.json` - Configuration for intermediate-scale Japanese pre-training of ModernBERT-1B
- `ModernBERT-EN-1B/stage1-bs8192.json` / `ModernBERT-EN-1B/stage2-bs1024.json` - Configuration for intermediate-scale English pre-training of ModernBERT-1B
- `ModernBERT-JP-3B/stage1-bs16384.json` / `ModernBERT-JP-3B/stage2-bs2048.json` - Configuration for scaled Japanese pre-training of ModernBERT-3B
- `ModernBERT-EN-3B/stage1-bs16384.json` / `ModernBERT-EN-3B/stage2-bs2048.json` - Configuration for scaled English pre-training of ModernBERT-3B
